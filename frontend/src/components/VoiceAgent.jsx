/**
 * FanLabz Voice Agent — GPT-4o Realtime via WebRTC + ephemeral token.
 * Cross-platform: iOS Safari ✅  Android Chrome ✅  Desktop ✅
 */
import { useEffect, useRef, useState, useCallback } from 'react';
import { createPortal } from 'react-dom';

const API_BASE = (import.meta.env.VITE_API_BASE_URL || 'https://fan-labz-chatbot-ai-assistant-oizw.vercel.app').replace(/\/$/, '');
